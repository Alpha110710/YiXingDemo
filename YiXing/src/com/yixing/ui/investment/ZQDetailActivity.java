...
public class ZQDetailActivity extends BaseActivity implements OnClickListener {

	private TextView zqProtocalText;// 产品编号
	...
	private void initView() {
		...
		zqProtocalText = (TextView) findViewById(R.id.zq_protocal_text);
		zqProtocalText.setOnClickListener(this);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.zq_protocal_text:// 协议范本

			Intent webView = new Intent(ZQDetailActivity.this,
					ActivityWebView.class);
			webView.putExtra(IntentExtraKey.WEB_VIEW_FROM, 8);
