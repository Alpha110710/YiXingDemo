...
public class ActivityReturnMoneyDetailOne extends BaseActivity implements OnClickListener {
	...
	private TextView tv_return_money_one_finaning;// 投资金额
	private TextView tv_return_money_one_finaning_company;// 投资金额单位
	...
	private void initView() {
		...
		tv_return_money_one_finaning_company = (TextView) findViewById(R.id.tv_return_money_one_finaning_company);
	...
	private void getPaymentDetails() {
		detailTask = new BizDataAsyncTask<BaseModel>() {
			...
			protected void onExecuteSucceeded(BaseModel result) {
				...
				tv_return_money_one_finaning_company.setText(one.getTENDER_AMOUNT_UNIT());
	...
	public void onClick(View v) {
		...
		case R.id.tv_return_money_one_pact:
			...
			if (tag.equals("3")) {
				//车贷标
				intent.putExtra(IntentExtraKey.WEB_VIEW_FROM, 5);
			} else {
