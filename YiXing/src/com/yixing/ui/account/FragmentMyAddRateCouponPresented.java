...
public class FragmentMyAddRateCouponPresented extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		return inflater.inflate(R.layout.fragment_my_add_rate_coupon_gived, container, false);
	}
	...
	private BizDataAsyncTask<List<MyAddRateCouponPresentedModel>> task;

	private void getMyAddRate(final boolean first, final boolean isPullDown) {

		task = new BizDataAsyncTask<List<MyAddRateCouponPresentedModel>>() {
			...
			protected void onExecuteSucceeded(List<MyAddRateCouponPresentedModel> result) {
				...
				for (int i = 0; i < result.size(); i++) {
					adapter.addItem((MyAddRateCouponPresentedModel) result.get(i));
				}
			...
			protected List<MyAddRateCouponPresentedModel> doExecute() throws ZYException, BizFailure {
				...
				if (isPullDown) {
					...
					if (isEnd) {
						return new ArrayList<MyAddRateCouponPresentedModel>();
					} else {
	...
	class AddRateCouponUsedListAdapter extends BaseAdapter {
		...
		private List<MyAddRateCouponPresentedModel> list = new ArrayList<MyAddRateCouponPresentedModel>();
