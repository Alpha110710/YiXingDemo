...
public class MyTransferingModel extends BaseModel implements Parcelable{
	   ...
	   /**
     * TRANSFER_CONTRACT_ID : EXJR1609070001Z
     * PRODUCTS_TITLE : 助农贷-公益活动筹款TG0722001
     * FINANCE_INTEREST_RATE : 9.38
     * FINANCE_PERIOD_FORMAT : 12个月
     * TRANSFER_CAPITAL_FORMAT : 5000.00/0.00
     * TRANSFER_CAPITAL_YES : 0.00
     * REMAIN_TIME : 22小时56分钟
     * TENDER_AMOUNT : 5000.00
     * TRANSFER_CAPITAL : 5000.00
     * TRANSFER_AMOUNT : 4059.11
     * TRANSFER_DETAIL : {"DETAIL_TENDER_AMOUNT":"5000.00","DETAIL_TRANSFER_CAPITAL":"5000.00","DETAIL_FAIR_VALUE":"5059.11","DETAIL_TRANSFER_AMOUNT":"4059.11","DETAIL_DISCOUNT_SCALE":"20","DETAIL_DISCOUNT_AMOUNT":"1000.00","DETAIL_TRANSFER_TIME":"2016-09-07 10:10:53","DETAIL_TRANSFER_MANAGE_FEE":"100.00","DETAIL_TRANSFER_STATUS":"转让中"}
     */
        ...
        /**
         * DETAIL_TENDER_AMOUNT : 5000.00
         * DETAIL_TRANSFER_CAPITAL : 5000.00
         * DETAIL_FAIR_VALUE : 5059.11
         * DETAIL_TRANSFER_AMOUNT : 4059.11
         * DETAIL_DISCOUNT_SCALE : 20
         * DETAIL_DISCOUNT_AMOUNT : 1000.00
         * DETAIL_TRANSFER_TIME : 2016-09-07 10:10:53
        ...
        public static class TRANSFERDETAILBean extends BaseModel implements Parcelable{
			...
			public static Parcelable.Creator<TRANSFERDETAILBean> CREATOR = new Creator<TRANSFERDETAILBean>() {
			...
			public static Parcelable.Creator<TRANSFERDETAILBean> getCREATOR() {
				return CREATOR;
			}

			public static void setCREATOR(Parcelable.Creator<TRANSFERDETAILBean> cREATOR) {
				CREATOR = cREATOR;
			}
		...
		public void writeToParcel(Parcel dest, int flags) {
			// TODO Auto-generated method stub
			QuickSetParcelableUtil.write(dest, MyTransferingModel.this);
		}
		
		public static Parcelable.Creator<MyTransferingModel> CREATOR = new Creator<MyTransferingModel>() {
		...
		public static Parcelable.Creator<MyTransferingModel> getCREATOR() {
			return CREATOR;
		}

		public static void setCREATOR(Parcelable.Creator<MyTransferingModel> cREATOR) {
			CREATOR = cREATOR;
		}
