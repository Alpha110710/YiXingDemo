...
import com.yixing.R;
import com.yixing.ui.widget.CustomDatePicker;
import com.yixing.ui.widget.CustomDatePicker.ChangingListener;
...
public class BirthdayPopupWindow extends PopupWindow {
	...
	public BirthdayPopupWindow(final Activity context, OnClickListener itemsOnClick) {
		...
		mMenuView = inflater.inflate(R.layout.activity_birthday, null);
