...
import com.yixing.R;
import com.yixing.ui.wheel.AbstractWheel;
import com.yixing.ui.wheel.AbstractWheelTextAdapter;
import com.yixing.ui.wheel.ArrayWheelAdapter;
import com.yixing.ui.wheel.OnWheelScrollListener;
import com.yixing.ui.wheel.WheelVerticalView;
...
//		setTextColor(adapter3);
	...
	public void setTextColor(AbstractWheelTextAdapter adapter) {
		adapter.setTextColor(context.getResources().getColor(R.color.black));
	}
